...
#define GPIO18_CTRL     0x094U
#define GPIO9_CTRL      0x04CU
...
int main()
{
    ...
    *RESET &= ~((1U<<5) | (1U << 8));
    ...
    volatile uint32_t *GPIO_CTRL = (volatile uint32_t *) (GPIO9_CTRL + IO_BANK0_BASE);
    // *GPIO_CTRL &= ~(0x1FU);  // clear bits 4:0
    // *GPIO_CTRL |= 0x5U;       // set function 5 (SIO)
    // *GPIO_CTRL = 5;
    *GPIO_CTRL = 0x5U;  // just write 5 directly — cleaner
